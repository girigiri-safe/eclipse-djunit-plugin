...
public class AsmMethodVisitor15x extends AbstractAsmMethodVisitor15x {
	...
	public AsmMethodVisitor15x(CodeVisitor methodVisitor, String className,
			String methodName, String desc, boolean isStatic, String[] exceptions, int maxLocals, String[] superClassNames) {
		super(methodVisitor, className, methodName, desc, isStatic, exceptions, maxLocals, superClassNames);
	}
